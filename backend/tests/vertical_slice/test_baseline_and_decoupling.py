...
BASELINE_WINDOWS = 9
BASELINE_CHECK_COUNT = 24  # C13 realized connectivity; C16 the entrance's own realization; C17 bathroom access; C18 parking clear of the house; C19 required rooms touch an exterior wall; C20 template aspect; C21 template maximum area; C23 entrance opens into an allowed arrival room; C24 access topology obeys the door rules; C25 (Issue #22) no dead-space pocket at the entrance — additive; C26 no extreme dedicated circulation; C29 (Issue #37) wet-room privacy — additive, runs on every plan with wet rooms
