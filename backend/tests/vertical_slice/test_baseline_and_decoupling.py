...
BASELINE_WINDOWS = 9
BASELINE_CHECK_COUNT = 19  # C13 realized connectivity; C16 the entrance's own realization; C17 bathroom access; C18 parking clear of the house; C20 template aspect; C21 template maximum area; C24 access topology obeys the door rules
