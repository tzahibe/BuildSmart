...
- **FR-008**: System MUST allow a user to update the city, street, plot area, and/or description of an existing project, leaving any fields not included in the update unchanged.
...
- **Project**: Represents a single home-building request. Attributes: project_id (unique identifier), city, street, plot_area_m2, description (verbatim source text), status, created timestamp, last-updated timestamp.
